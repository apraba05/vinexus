...
const PLANS = [
  {
    ...
    price: "$0",
    period: "/month",
    features: ["1 VM connection", "Llama 3.1 8B AI", "500K tokens/month", "Git source control"],
  ...
  },
  {
    ...
    period: "/month",
    badge: "Most Popular",
    features: ["Unlimited VM connections", "Claude Sonnet AI", "8M tokens/month", "Deployment pipelines"],
    cta: "Get Max",
    href: "/pricing",
    highlight: true,
  },
  ...
  },
  {
    ...
    price: "Contact",
    period: "",
    features: ["Custom token allocation", "Claude Opus AI", "SSO & access controls", "Dedicated support engineer"],
    cta: "Contact Us",
    href: "/contact",
  },
];
