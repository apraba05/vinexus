...
const PLAN_COLORS: Record<Plan, { bg: string; border: string; text: string; dot: string }> = {
  free:       { bg: "rgba(100,140,200,0.06)", border: "rgba(100,140,200,0.18)", text: "#8fa3c8", dot: "#5a7ab0" },
  premium:    { bg: "rgba(59,130,246,0.08)",  border: "rgba(59,130,246,0.22)",  text: "#3b82f6", dot: "#3b82f6" },
  max:        { bg: "rgba(0,83,219,0.1)",     border: "rgba(0,83,219,0.25)",    text: "#6394ff", dot: "#3b82f6" },
  "ai-pro":   { bg: "rgba(168,85,247,0.1)",   border: "rgba(168,85,247,0.25)", text: "#c084fc", dot: "#a855f7" },
  enterprise: { bg: "rgba(139,92,246,0.08)",  border: "rgba(139,92,246,0.22)", text: "#a78bfa", dot: "#8b5cf6" },
};
...
export default function DashboardPage() {
  ...
  return (
    <>
      <NavBar />
      <div style={{ background: D.surface, minHeight: "100vh", padding: "52px 24px 100px" }}>
        ...
        <div style={{ position: "relative", maxWidth: 960, margin: "0 auto" }}>
          ...
          {session && !emailVerified && (
            <div style={{
              padding: "11px 18px", marginBottom: 32,
              ...
              <button
                ...
                style={{ padding: "4px 12px", background: "rgba(234,179,8,0.08)", border: "1px solid rgba(234,179,8,0.2)", borderRadius: 6, fontSize: 12, color: "#ca8a04", cursor: "pointer", fontFamily: "inherit" }}
              >
                Resend
              </button>
            </div>
          ...
          <div style={{ marginBottom: 48 }}>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 6 }}>
              <h1 style={{ fontSize: 28, fontWeight: 700, color: D.inverseSurface, letterSpacing: "-0.03em", margin: 0 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 340px", gap: 24, alignItems: "start" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
              ...
              <div style={{
                borderRadius: 16,
                padding: "32px 36px",
                background: `linear-gradient(135deg, ${D.surfaceContainerLow} 0%, ${D.surface} 100%)`,
                boxShadow: `0 1px 3px ${D.outlineVariant}40, 0 0 0 1px ${D.outlineVariant}`,
                position: "relative",
                overflow: "hidden",
              }}>
                <div aria-hidden style={{
                  position: "absolute", top: -80, right: -60, width: 340, height: 340,
                  background: `radial-gradient(ellipse, ${D.primary}0e 0%, transparent 65%)`,
                  pointerEvents: "none",
                }} />
                <div style={{ position: "relative" }}>
                  <p style={{ fontSize: 11, fontWeight: 700, color: D.primary, letterSpacing: "0.08em", textTransform: "uppercase" as const, margin: "0 0 12px" }}>
                    Vinexus Desktop
                  </p>
                  <h2 style={{ fontSize: 22, fontWeight: 700, color: D.inverseSurface, letterSpacing: "-0.03em", margin: "0 0 10px", lineHeight: 1.25 }}>
                    Connect to any VM.<br />Code like you&apos;re local.
                  </h2>
                  <p style={{ fontSize: 13.5, color: D.onSurfaceVariant, lineHeight: 1.7, margin: "0 0 24px", maxWidth: 420 }}>
                  ...
                  <div style={{ display: "flex", gap: 10, flexWrap: "wrap" as const, alignItems: "center" }}>
                    <a
                      ...
                      style={{
                        ...
                        padding: "10px 22px", background: D.inverseSurface, color: D.surface,
                        borderRadius: 9999, fontSize: 13, fontWeight: 700, textDecoration: "none",
                        boxShadow: `0 2px 8px ${D.inverseSurface}20`,
                      }}
                    >
                    ...
                    <a
                      ...
                      style={{
                        display: "inline-flex", alignItems: "center", gap: 8,
                        padding: "10px 22px", background: "transparent", color: D.onSurface,
                  ...
                  <p style={{ fontSize: 11, color: D.onSurfaceVariant, margin: "12px 0 0" }}>macOS 12+ · Windows 10+ · ARM & x86_64</p>
                </div>
              </div>
                ...
                {[
                  {
                    href: "/docs",
                    label: "Documentation",
                    sub: "Guides, API reference, and setup tutorials",
                    color: "#3b82f6",
                  ...
                  },
                  {
                    ...
                    sub: "Set up AI pair programming directly on your VM",
                    color: "#ec4899",
                  ...
                  },
                  {
                    ...
                    sub: "Manage your profile, subscription and payment",
                    color: "#8b5cf6",
                  ...
                  <Link key={item.href} href={item.href} style={{ textDecoration: "none" }}>
                    ...
                    onMouseEnter={e => { (e.currentTarget as HTMLDivElement).style.background = `${D.surfaceContainerLow}`; (e.currentTarget as HTMLDivElement).style.borderColor = D.outlineVariant; }}
                    ...
                    >
                      ...
                      <div style={{ flex: 1, minWidth: 0 }}>
                        <div style={{ fontSize: 13.5, fontWeight: 600, color: D.inverseSurface, marginBottom: 1 }}>{item.label}</div>
                        <div style={{ fontSize: 12, color: D.onSurfaceVariant }}>{item.sub}</div>
                      </div>
                      <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke={D.outlineVariant} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="5" y1="12" x2="19" y2="12"/><polyline points="12 5 19 12 12 19"/></svg>
                    </div>
                  </Link>
                ))}
              </div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
              ...
              <div style={{
                ...
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 16 }}>
                  <span style={{ fontSize: 14, fontWeight: 600, color: D.inverseSurface }}>Your Plan</span>
                  <span style={{
                    padding: "3px 10px", borderRadius: 9999,
                    background: planColor.bg, border: `1px solid ${planColor.border}`,
                    fontSize: 11, fontWeight: 700, color: planColor.text,
                  }}>
                    {PLAN_LABELS[userPlan]}
                  </span>
                </div>

                <div style={{ fontSize: 26, fontWeight: 700, color: D.inverseSurface, letterSpacing: "-0.03em", marginBottom: 16 }}>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 8, marginBottom: 20 }}>
                  {[
                    ...
                    <div key={i} style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                      <span style={{ fontSize: 12.5, color: D.onSurfaceVariant }}>{f.label}</span>
                      {"value" in f ? (
                        <span style={{ fontSize: 12.5, fontWeight: 600, color: D.inverseSurface }}>{f.value}</span>
                      ) : (
                        f.on
              ...
              <div style={{
                ...
                <div style={{ position: "relative" }}>
                  <p style={{ fontSize: 10, fontWeight: 700, color: "#ec4899", letterSpacing: "0.08em", textTransform: "uppercase" as const, margin: "0 0 10px" }}>
                    Claude Code
                  </p>
                  <h3 style={{ fontSize: 15, fontWeight: 700, color: D.inverseSurface, margin: "0 0 8px", lineHeight: 1.35 }}>
                    AI pair programming on your VM
                  </h3>
                  <p style={{ fontSize: 12.5, color: D.onSurfaceVariant, lineHeight: 1.65, margin: "0 0 16px" }}>
                    Run Claude Code directly in the Vinexus terminal using your own Anthropic API key — available on all plans.
                  </p>
                  <Link href="/docs#claude-integration" style={{
                    ...
                    color: "#ec4899", fontSize: 12.5, fontWeight: 600, textDecoration: "none",
                  }}>
                    Setup Guide
