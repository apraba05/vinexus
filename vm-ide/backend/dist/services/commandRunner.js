...
exports.commandRunner = exports.CommandRunner = void 0;
...
class CommandRunner {
     ...
     */
    async runTemplate(sessionId, templateId, params) {
        ...
        for (const pDef of template.parameters) {
            ...
            if (!SAFE_PARAM_RE.test(strValue)) {
                throw new Error(`Invalid parameter value for '${pDef.name}': contains disallowed characters`);
            }
     ...
     */
    async runCustom(sessionId, command, sudo = false, timeout = 30_000) {
